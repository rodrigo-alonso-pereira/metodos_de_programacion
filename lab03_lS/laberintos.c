...
#define nombre_archivo_laberinto "Mapa-307.txt"
...
int main() {
    ...
    printf("\nPosicion 'E' es: [%d][%d]\n", posicion_inicial[0], posicion_inicial[1]);
    printf("Posicion 'P' es: [%d][%d]\n", posicion_final[0], posicion_final[1]);
    printf("Posicion 'K' es: [%d][%d]\n", posicion_llave[0], posicion_llave[1]);
    ...
    while (n_abiertos_1 > 0) {
        ...
        if(evaluaEstadoFinal(laberinto, posicion_actual_1, 'K') == 1){
            ...
            //printf("\n\nPasos escritos en el laberinto:\n");
            //printf("-------------------------------------------------------------------------------\n");
            //imprimirPasosEnLaberinto(laberinto, estados_cerrados_1, n_cerrados_1);
        } else {
    ...
    while (n_abiertos_2 > 0) {
        ...
        if (evaluaEstadoFinal(laberinto, posicion_actual_2, 'P') == 1) {
            ...
            //printf("\n\nPasos escritos en el laberinto:\n");
            //printf("-------------------------------------------------------------------------------\n");
            //imprimirPasosEnLaberinto(laberinto, estados_cerrados_2, n_cerrados_2);
            return 0;
        } else {
            //Paso 4: Si no es estado final, aplicar todas las transiciones en orden.
            //Arriba
